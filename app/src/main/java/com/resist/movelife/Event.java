...
public class Event {
	...
	private Event(Cursor c) {
		this(c.getInt(c.getColumnIndex("eid")), c.getInt(c.getColumnIndex("bid")), c.getInt(c.getColumnIndex("uid")), c.getString(c.getColumnIndex("name")), c.getString(c.getColumnIndex("description")), c.getString(c.getColumnIndex("startdate")), c.getString(c.getColumnIndex("enddate")));
		try {
